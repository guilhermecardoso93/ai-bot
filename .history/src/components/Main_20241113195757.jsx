      ...
      <div className="chat-footer">
        <form action="" className="chat-form">
          <textarea
            ...
            value={messageInput} // Vincula o valor da textarea ao estado
            onChange={(e) => setMessageInput(e.target.value)} // Atualiza o estado
          ...
          <div className="chat-controls">
            ...
            <button type="button" className="material-symbols-rounded" onClick={handleOutGoingMessage}>
              <ArrowUp />
            </button>
          </div>
        </form>
